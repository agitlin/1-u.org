const id = "morning-walk-sovereignty.md";
						const collection = "articles";
						const slug = "morning-walk-sovereignty";
						...
						const data = {title:"Morning Walk Sovereignty",date:"2026-02-16",tags:["sovereignty","values","identity","philosophy"],description:"Sovereignty: putting yourself first not as selfishness but as the necessary precondition for everything that follows."};
						const _internal = {
							type: 'content',
							filePath: "/sessions/kind-gracious-gauss/mnt/1u/sites/1-u.org/src/content/articles/morning-walk-sovereignty.md",
							rawData: undefined,
						};
