const id = "bashert.md";
						...
						const data = {title:"Bashert — The Life of Truth, Not Convenience",date:"2026-01-25",tags:["values","courage","identity","philosophy"],description:"The word 'bashert' provides a harder and more meaningful alternative to a life of convenience. Aiming higher creates a pull that keeps you from settling for the easy exit."};
						const _internal = {
							type: 'content',
							filePath: "/sessions/kind-gracious-gauss/mnt/1u/sites/1-u.org/src/content/articles/bashert.md",
							rawData: undefined,
						};
